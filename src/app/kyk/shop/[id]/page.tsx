...
import { Reply, Heart, CheckCircle2, Check } from 'lucide-react'
import { cookies } from 'next/headers'
import { dictionaries } from '@/lib/i18n/dictionaries'
import { ShareButton } from './ShareButton'
import ProductPaymentBar from './ProductPaymentBar'
...
export default async function ShopItemPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F7F8F9] relative w-full max-w-[600px] mx-auto border-x border-slate-50 font-sans">
      ...
      <ProductPaymentBar productId={Number(resolvedParams.id)} />
