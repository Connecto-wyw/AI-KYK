...
langs.forEach(lang => {
  ...
  // Create regex to match 'shopBackToTeam: "..."' line
  const regex = /shopBackToTeam:\s*".*"/g;
  
  // Find the match for this language exactly
  ...
  // Find the exact shopBackToTeam line in this block
...
console.log('Successfully patched dictionaries.ts');
